...
L<Data::Sah::Value>, which lets you define cell function by returning a Perl (or
JavaScript, etc) expression to define the function. Used in code generation like
...
Bridges between us and C<Data::Sah::Value>: L<CellFunc::from_dsv> and
L<Data::Sah::Value::from_cellfunc>.

Some applications let you specify cell functions or Data::Sah::Value functions
